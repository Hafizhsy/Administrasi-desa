    ...
    <main class="flex-grow flex items-center justify-center px-margin-mobile md:px-gutter py-stack-lg">
        <div class="max-w-[1280px] w-full grid grid-cols-1 md:grid-cols-12 gap-gutter items-center">
            <section class="hidden md:flex md:col-span-7 flex-col gap-stack-md pr-12">
                ...
                <h1 class="font-h1 text-h1 text-on-surface leading-tight">Akses Layanan Administrasi Desa dalam
                    Genggaman.</h1>
                <p class="font-body-lg text-body-lg text-on-surface-variant max-w-lg">
                    Masuk untuk mengajukan surat keterangan, memantau status permohonan, dan mendapatkan informasi
                    terkini dari Pemerintah Desa Kopandakan I.
                </p>
                <div class="grid grid-cols-2 gap-4 mt-8">
                    <div class="p-6 bg-white border border-outline-variant rounded-xl shadow-sm">
                        ...
                        <p class="font-label-sm text-label-sm text-on-surface-variant">Pengajuan surat online tanpa
                            antre.</p>
                    </div>
                    <div class="p-6 bg-white border border-outline-variant rounded-xl shadow-sm">
                        ...
                        <p class="font-label-sm text-label-sm text-on-surface-variant">Berita dan pengumuman desa
                            terbaru.</p>
                    </div>
                </div>
            </section>
            <section class="col-span-1 md:col-span-5">
                <div
                    class="bg-white p-8 md:p-10 rounded-xl border border-outline-variant shadow-sm w-full max-w-md mx-auto">
                    <div class="md:hidden flex flex-col items-center mb-8">
                        <img alt="Village Logo" class="w-12 h-12 rounded-lg mb-4"
                            data-alt="Simplified version of the Kopandakan I village logo for mobile display"
                            src="https://lh3.googleusercontent.com/aida-public/AB6AXuC6Lgmcg3pIzBHHXQ8lZoJsaifbCfYmEBAHIUVrX1jzZvP4RnIoyloqqX2da0bkvG1TyA5R8spDksJ7qsVKrDVj7HG5o3TgQMGAQZ59efTOzwMZLzksEGlLFCARL7Pzw8mng6VKMXTnQ7_LZnzqf7vC5lCHAiydXGflomi5k1dzeREtxhvP-VHNsIFXFr3NaGmZrc8zebUigVX15-Vpa3YD0ZZAWa8TPgW2aSJKkSuUurjI7Mp_x4X6nZGQ_x1H07Q47A0u-jk36Bg" />
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between items-center px-1">
                                <label class="font-label-sm text-label-sm text-on-surface-variant" for="password">Kata
                                    Sandi</label>
                                <a class="font-label-sm text-label-sm text-tertiary hover:underline"
                        ...
                        <div class="flex items-center gap-3 px-1">
                            ...
                            <label class="font-label-sm text-label-sm text-on-surface-variant cursor-pointer"
                                for="remember">Ingat saya di perangkat ini</label>
                        </div>
                        <button
                    ...
                    <div class="mt-10 pt-8 border-t border-outline-variant text-center">
                        <p class="font-body-md text-body-md text-on-surface-variant">
                            Belum memiliki akun?
                            <a class="text-tertiary font-bold hover:underline ml-1"
        ...
        <div class="flex flex-col md:flex-row items-center gap-6">
            ...
            <div class="flex gap-4">
                <a class="font-public-sans text-xs text-slate-500 hover:text-emerald-700 transition-colors"
                    href="#">Kontak</a>
                <a class="font-public-sans text-xs text-slate-500 hover:text-emerald-700 transition-colors"
                    href="https://maps.app.goo.gl/LtfdfQzweUsmArGP8">Peta Desa</a>
                <a class="font-public-sans text-xs text-slate-500 hover:text-emerald-700 transition-colors"
