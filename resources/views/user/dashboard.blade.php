...
<body class="bg-surface text-on-surface">
  ...
  <header
    ...
    <button
      class="w-10 h-10 flex items-center justify-center rounded-full hover:bg-slate-100 transition-colors active:scale-95 duration-150">
    ...
    <section class="mb-stack-md">
      <div class="relative overflow-hidden rounded-xl bg-primary p-8 text-on-primary">
        <div class="relative z-10">
          ...
          <p class="font-body-lg text-body-lg opacity-90 max-w-xl">Selamat datang kembali di portal layanan digital Desa
            Kopandakan I. Urus kebutuhan administratif Anda lebih cepat dan transparan.</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
      ...
      <div class="lg:col-span-4 flex flex-col gap-stack-md">
        ...
        <div class="bg-white p-6 rounded-xl border border-slate-200">
          ...
          <p class="font-body-md text-slate-600 mb-6">Ajukan dokumen Anda secara digital tanpa perlu mengantri di balai
            desa.</p>
          <button
  ...
  <nav
    ...
    <a class="flex flex-col items-center justify-center bg-emerald-50 text-emerald-900 rounded-xl px-4 py-1.5 active:scale-90 transition-transform"
      href="#">
