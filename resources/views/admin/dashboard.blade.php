...
<img alt="Village Emblem" class="w-8 h-8" data-alt="Official village emblem of Kopandakan I showing administrative authority and local heritage" src="https://tse2.mm.bing.net/th/id/OIP.e3qAPtdwr3_s22nmrHur3AHaIo?rs=1&pid=ImgDetMain&o=7&rm=3"/>
</div>
...
<img alt="Admin Avatar" class="w-10 h-10 rounded-lg object-cover" data-alt="Professional portrait of a male administrative official in business attire, clean background" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCxqattrOzrZ_z2WWKGe_agUgoqox-CBpdIg9lsc1hbn9hA-QCx80aUDIz4nNDagzOfJ-28c9J1oWbtGNZd-7ka_2Po3GraS4VSrfHNB_ToMyofZWKXrJQbjWDBdPfMGToCQZFsgnAwQGXlP-Sub1D99fLZh_YZ06obtHNCEj7X3Na7gTrdkVkUQg5SWRVJejMLUFzyTtV4B9NPT6NxvJIY28XNj1UjIiDXAm5BUfxn2tuS32IdFer_Hd7Wzv0SdO2NqTTFYYtH0LE"/>
</div>
<div>
...
<nav class="space-y-1">
<a class="flex items-center gap-3 bg-emerald-900 text-white rounded-lg mx-2 px-4 py-3 font-medium text-sm transition-all duration-200" href="#">
<span class="material-symbols-outlined">dashboard</span>
                    Dashboard
                </a>
<a class="flex items-center gap-3 text-slate-600 hover:bg-slate-100 mx-2 rounded-lg px-4 py-3 font-medium text-sm transition-all duration-200" href="#">
...
<button class="bg-primary-container text-on-primary-fixed-variant px-6 py-3 rounded-xl font-button text-button flex items-center gap-2 hover:bg-primary transition-colors active:scale-95 shadow-sm" onclick="window.location.href='#'">
...
<a class="bg-white border border-slate-200 p-6 rounded-xl flex flex-col gap-4 hover:shadow-md transition-shadow cursor-pointer" href="#"><div class="flex justify-between items-start"><div class="p-3 bg-error-container rounded-lg"><span class="material-symbols-outlined text-on-error-container">pending_actions</span></div><span class="text-error font-bold text-sm">+5 hari ini</span></div><div><p class="text-slate-500 font-label-sm text-label-sm">Pending Requests</p><h4 class="text-3xl font-h2 text-h2 text-emerald-900">24</h4></div></a>
...
<img alt="User" class="w-10 h-10 rounded-full object-cover" data-alt="Portrait of a young male citizen in casual wear, neutral background" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAAN8e_FE2CfzVUFmCrvStEg8opfgQbfDWLv2Ny3bVsd_TBKn2H7Pv3FJWCOpihD6NVKjy4YptqbmwCoANXO-E85rw2qHc5O-8madl_X8NuLA03H3dkhNBSoDNqA9kgdvTKn-hiYbjluvVoFb4zJrwAwh_rOXtlc6XnEVHHv-LQ8mHic5AaGe3Wp58QmA_echUiN1vozD6xjZRD_QtfHGUl-7PAW7NZF02px-979-39iAyrTWBNR4YEvOE6AV6eNHdSz_aio9Jm-x8"/>
<div class="flex-1">
<div class="flex justify-between items-start">
<p class="font-bold text-emerald-900">Andi Saputra</p>
<span class="text-xs text-slate-400">10 Menit yang lalu</span>
</div>
<p class="text-sm text-slate-600">Mengajukan permohonan <span class="font-semibold">Surat Keterangan Usaha</span></p>
<div class="mt-2 flex gap-2">
<button class="text-xs font-bold text-primary bg-primary-fixed px-3 py-1 rounded-full" onclick="window.location.href='#'">Review</button>
...
<div class="p-6 hover:bg-slate-50 transition-colors">
<div class="flex gap-4">
<img alt="User" class="w-10 h-10 rounded-full object-cover" data-alt="Portrait of a friendly middle-aged woman, smiling, bright natural light" src="https://lh3.googleusercontent.com/aida-public/AB6AXuClfz6aRCliJU6tSOvo7GhhYL_8ijTPDcDTv84oync-x_H9F5ZuGvhaRjsC6mPGrJmo52b4ssC9wNeG1D0pzmbaEMc_QvDcZ9w9peg-cscZhBK1r5Q7vz37bgIcmTzn0V1nVJmUXNjA5LgZds0I7tb5D8Yov8GMicTt0rQXzMtpxsXz8GeDBcVmRhweJrR_dIH2xx6xvw2WwONSPA9s0UwZNZ6iW-BTDFoRVqok5vYjzgreHx5WQ3PwKVmEcqcwun3FMLzfqVF0Q-0"/>
<div class="flex-1">
<div class="flex justify-between items-start">
<p class="font-bold text-emerald-900">Siti Rahayu</p>
<span class="text-xs text-slate-400">2 Jam yang lalu</span>
</div>
<p class="text-sm text-slate-600">Mengajukan permohonan <span class="font-semibold">Surat Keterangan Domisili</span></p>
<div class="mt-2">
<span class="text-xs font-bold text-emerald-600 bg-emerald-50 px-3 py-1 rounded-full border border-emerald-100">Sedang Diproses</span>
</div>
</div>
</div>
</div>
...
<div class="p-6 hover:bg-slate-50 transition-colors">
<div class="flex gap-4">
<img alt="User" class="w-10 h-10 rounded-full object-cover" data-alt="Portrait of a professional man in spectacles, clean studio lighting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBThG5ORJeC2H9v2XmXqWA3ZOQVxXSP1JP4vMI_uOBzIoUKI0vnsKGZ_IUg0CEeqfygyF28UbMhYpaKK5SMTE3htwWO8dZqskdyfkCr_81v37vN34UeC6_JBCf2g5sCxhPFl-sQmZHeDgCI8JW_snHCG3SNc4mRbmJBQea2gjYxa85X5B9c0Wf4UkIc6BXxZy20dUAZxr4kK2XDOSLaBTKIhNyJwvawJqH5zApQO4_CdkF77LBwizlhlxMC6PZgXmf7SOYQOL76Ju8"/>
<div class="flex-1">
<div class="flex justify-between items-start">
<p class="font-bold text-emerald-900">Budi Santoso</p>
<span class="text-xs text-slate-400">4 Jam yang lalu</span>
</div>
<p class="text-sm text-slate-600">Mengajukan permohonan <span class="font-semibold">Surat Pengantar Nikah</span></p>
<div class="mt-2 flex gap-2">
<button class="text-xs font-bold text-primary bg-primary-fixed px-3 py-1 rounded-full" onclick="window.location.href='#'">Review</button>
</div>
</div>
...
<p class="text-emerald-100 text-sm mb-4">Agenda rapat koordinasi perangkat desa dijadwalkan besok pukul 09:00 WIB.</p>
...
<nav class="md:hidden fixed bottom-0 left-0 w-full bg-white border-t border-slate-200 shadow-lg flex justify-around items-center px-2 pb-safe py-2 z-50">
<a class="flex flex-col items-center justify-center bg-emerald-50 text-emerald-900 rounded-xl px-4 py-1.5 transition-transform active:scale-90" href="#">
<span class="material-symbols-outlined">home</span>
<span class="font-public-sans text-[11px] font-semibold">Beranda</span>
</a>
<a class="flex flex-col items-center justify-center text-slate-500 px-4 py-1.5 hover:bg-slate-50 transition-transform active:scale-90" href="#">
...
<a class="font-public-sans text-xs text-slate-500 hover:text-emerald-700 transition-opacity opacity-80 hover:opacity-100" href="#">Kontak</a>
<a class="font-public-sans text-xs text-slate-500 hover:text-emerald-700 transition-opacity opacity-80 hover:opacity-100" href="#">Peta Desa</a>
<a class="font-public-sans text-xs text-slate-500 hover:text-emerald-700 transition-opacity opacity-80 hover:opacity-100" href="#">Kebijakan Privasi</a>
</div>
</div>
</footer>
</body></html>